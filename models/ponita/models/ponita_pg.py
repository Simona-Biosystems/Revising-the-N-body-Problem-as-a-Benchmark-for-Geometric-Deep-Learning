...
from models.ponita.nn.conv import Conv, FiberBundleConv
from models.ponita.nn.convnext import ConvNext
from models.ponita.nn.embedding import PolynomialFeatures
from models.ponita.transforms import PositionOrientationGraph, SEnInvariantAttributes
from models.ponita.utils.to_from_sphere import sphere_to_scalar, sphere_to_vec
from models.ponita.utils.windowing import PolynomialCutoff
        ...
        **kwargs
        ...
        for i in range(num_layers):
            conv = FiberBundleConv(
                hidden_dim, hidden_dim, basis_dim, groups=hidden_dim, separable=True
            )
            layer = ConvNext(
                hidden_dim,
                conv,
